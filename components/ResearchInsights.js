          ...
          <div className="mt-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="h-2 bg-[#e4e4e7] rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[#718096] rounded-full transition-all duration-700"
                    style={{ width: "31.6%" }}
                  />
                </div>
              </div>
            ...
            <div className="pb-3 border-b border-[#e4e4e7]">
              <div className="flex justify-between mb-2">
                <div className="flex items-center gap-2">
                  <span className="text-lg font-bold text-[#131315]">
                    70%
                  </span>
        ...
        <article className="bg-white rounded-2xl p-6 lg:p-8 border border-[#e4e4e7]">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="h-2 bg-[#e4e4e7] rounded-full overflow-hidden">
                <div
                  className="h-full bg-[#131315] rounded-full transition-all duration-500"
                  style={{ width: "71.4%" }}
                />
              </div>
            </div>
        ...
        <article className="bg-white rounded-2xl p-6 lg:p-8 border border-[#e4e4e7]">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="h-2 bg-[#e4e4e7] rounded-full overflow-hidden">
                <div
                  className="h-full bg-[#718096] rounded-full"
                  style={{ width: "70%" }}
                />
              </div>
            </div>
